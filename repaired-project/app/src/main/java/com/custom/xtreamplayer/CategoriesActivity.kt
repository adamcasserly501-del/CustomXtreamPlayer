            ...
            init {
                view.setOnClickListener {
                    ...
                    if (position != RecyclerView.NO_POSITION) {
                        val targetActivity = if (sectionType == "LIVE") LiveTvActivity::class.java else PlayerActivity::class.java
                        val intent = Intent(this@CategoriesActivity, targetActivity)
